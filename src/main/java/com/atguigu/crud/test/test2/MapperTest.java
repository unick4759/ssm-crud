package com.atguigu.crud.test.test2;
...
public class MapperTest {
	...
	public void testCRUD() {
		...
		// 2、生成员工数据，测试员工插入
//		employeeMapper.insertSelective(new Employee("Jerry", "M", "Jerry@atguigu.com", 1));
...
//			mapper.insertSelective(new Employee(uid, "M", uid + "@atguigu.com", 1));
//		}
